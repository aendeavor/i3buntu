...
function check_on_interactive { case $- in *i*) ;; *) exit ;; esac ; }

function history_parameters   { HISTCONTROL=ignoreboth ; HISTSIZE=10000 ; HISTFILESIZE=10000 ; }
function shopts               { shopt -s histappend checkwinsize globstar autocd ; }
