use super::super::{log::console, traits::ExitCodeCompatible};
...
impl Choices {
	pub fn new(tex: bool, java: bool, ct: bool, be: bool, oc: bool,
	           dock: bool, vsc: bool, rust: bool) -> Self
	{
		Choices {
			tex, java, ct, be,
			oc, dock, vsc, rust,
...
pub struct ApolloResult {
	success: bool,
	abort: bool,
	/// Exit codes between 0 - 99 indicate a recoverable error.
	///
...
impl ApolloResult {
	...
	pub fn set_failure(&mut self, exit_code: u8)
	{
		if self.exit_code > 99 {
			panic!(
				"Setting the error code twice is\
